...
module.exports = robot => {
  ...
  robot.respond(/おみくじ/i, msg => {
    ...
    var omikuzi_randam = Math.floor(
      Math.random() * Object.keys(omikuzi).length
    );
          ...
          .done(function(data) {
            ...
            for (let tennki = 0; tennki < 20; tennki++) {
              ...
              switch (data.list[tennki].weather[0].main) {
                ...
                default:
                  tenkiaa +=
                    data.list[tennki].weather[0].main +
